...
export const BesucherCard = ({ name, date }: BesucherCardProps) => {
  const first_2_letters = name.slice(0, 2).toUpperCase();

  return (
    <div className="border-b flex flex-row p-2 hover:bg-gray-200 cursor-pointer">
